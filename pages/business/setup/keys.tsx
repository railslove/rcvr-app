      ...
      {wasGenerated ? (
        ...
        <>
          <Text>
            ...
            <p>
              {isCareEnv
                ? 'Schreiben Sie den Schlüssel zum Beispiel auf einen Zettel und verwahren ihn sorgfältig. Oder machen Sie einen Screenshot davon und speichern Sie ihn. Sie können ihn auch in einem Passwortmanager speichern.'
